...
- **Bid Manager API v2** (`doubleclickbidmanager.googleapis.com/v2`): Reporting queries with comprehensive groupBys (21 filters: date, advertiser, ad position/type, IO/LI/creative details, channels, YouTube video ID, media plan/type) and metrics (28 metrics: impressions, clicks, spend, conversions, video quartiles, viewability, billable cost, companion, frequency).
