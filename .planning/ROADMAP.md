...
- [x] **Phase 25: Configurable Concurrency** - SuperAdmin UI + backend semaphore for max_concurrent_downloads (completed 2026-05-19)
...
**Plans**: 3 plans
- [x] 25-01-PLAN.md — SystemConfig.max_concurrent_downloads column + Alembic migration + proxy_cache.get_concurrency_semaphore() with 60s TTL + unit tests (Wave 1)
- [x] 25-02-PLAN.md — Wrap DV360 + Google Ads _do_download with semaphore + GET/PUT /super-admin/download-concurrency endpoints + endpoint tests (Wave 2)
- [x] 25-03-PLAN.md — Admin UI restructure: merge Residential Proxy + YouTube Cookies into 'Download Settings' section + new Parallel Downloads mat-slider + human-verify checkpoint (Wave 3)
**UI hint**: yes
...
| 25. Configurable Concurrency | v1.5 | 3/3 | Complete   | 2026-05-19 |
