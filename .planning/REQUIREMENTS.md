...
- [x] **PERF-02**: SuperAdmin can configure max concurrent downloads per sync batch (default 3, range 1–10) via a setting in the SuperAdmin UI; all platforms (DV360 + Google Ads) respect the limit via a shared asyncio semaphore
