...
export class ApiService {
  ...
  redownloadAsset(assetId: string): Observable<{ asset_id: string; job_id: string; queued: boolean }> {
    return this.http.post<{ asset_id: string; job_id: string; queued: boolean }>(`${this.base}/assets/${assetId}/redownload`, {});
  }
