        ...
        query_body = {
            ...
            "params": {
                ...
                "metrics": [
                    ...
                    "METRIC_VIDEO_FIRST_QUARTILE_VIEWS",
                    "METRIC_VIDEO_MIDPOINT_VIEWS",
                    "METRIC_VIDEO_THIRD_QUARTILE_VIEWS",
    ...
    async def _upsert_records(
        ...
        for r in records:
            ...
            rows.append({
                ...
                "cpm": safe_decimal(r.get("CPM (Advertiser Currency)")),
                "cpc": safe_decimal(r.get("CPC (Advertiser Currency)")),
                ...
                "video_completions": safe_int(r.get("Video Completions")),
                "video_first_quartile": safe_int(r.get("Video First Quartile Views")),
                "video_midpoint": safe_int(r.get("Video Midpoint Views")),
                "video_third_quartile": safe_int(r.get("Video Third Quartile Views")),
                "video_completion_rate": safe_float(r.get("Video Completion Rate")),
                "video_plays": safe_int(r.get("Rich Media Video Plays")),
