...
class HarmonizationService:
        ...
        for raw in raw_records:
            try:
                ...
                row = {
                    ...
                    "publisher_platform": raw.publisher_platform or "",
                    "platform_position": raw.platform_position or "",
    ...
    async def _harmonize_dv360(
            ...
            try:
                async with db.begin_nested():
                    ...
                    h_row = {
                        ...
                        "cost_per_view": convert(row.cost_per_view),
                        "thruplay": None,
                        "cost_per_thruplay": None,
                        "focused_view": None,
                        "cost_per_focused_view": None,
                        ...
                        "platform_extras": {
                            ...
                            "active_view_measurable_impressions": row.active_view_measurable_impressions,
                            "active_view_viewable_impressions": row.active_view_viewable_impressions,
                            "video_skips": row.video_skips,
        ...
        if harmonized_count > 0:
            await db.flush()
        logger.info(f"Harmonized {harmonized_count} DV360 records for connection {connection.id} ({error_count} errors)")
