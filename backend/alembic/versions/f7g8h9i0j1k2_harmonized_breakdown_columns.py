...
def upgrade() -> None:
    op.add_column("harmonized_performance", sa.Column("publisher_platform", sa.String(100), nullable=False, server_default=""))
    op.add_column("harmonized_performance", sa.Column("platform_position", sa.String(100), nullable=False, server_default=""))
